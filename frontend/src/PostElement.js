    ...
    <div>
      <div className="post-element-container">
        <div className="post-element-upper-bar">
          <img
            className="post-element-upper-bar-icon"
            src={profilePicture}
            alt="pp"
          />
          <div className="post-element-upper-bar-username">{username}</div>
          <div className="post-element-upper-bar-date"> • {time}</div>
          <div className="post-element-upper-bar-button">
            <a className="post-element-upper-bar-button" href="/#">
              •••
            </a>
          </div>
        </div>
        ...
        <div className="post-element-bottom-bar">
          ...
          <div>
            <img src={comment_icon} alt="comments" width="24px" />
          </div>
          <div>
            <img src={send_icon} alt="comments" width="24px" />
          </div>
          {/* <div><img src={save_icon} alt="comments" style={{position: "absolute", right: "0"}} height="26px"/>
                    </div> */}
        </div>
        <div>
          <h4 style={{ margin: 0 }}>{likeCount}&nbsp;likes</h4>
        </div>
        ...
        <div>
          <input
            className="post-element-bottom-bar-comment-area"
            type="text"
